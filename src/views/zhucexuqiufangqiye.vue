    ...
    <div>
        ...
        <div class="jiafang">
            <ul>
                ...
                <li class="li4">
                    <input placeholder=" 输入验证码" v-model="yanzhengma" @focus="huoqujiaodian3()" @blur="shiqujiaodian3()" ref="input3"/>
                </li>
                <li class="li5">
                ...
                <li class="li9">
                    <router-link to="/zhuce"><input type="button" value="返回选择需求方类型"/></router-link>
